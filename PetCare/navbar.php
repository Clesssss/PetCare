...
if (isset($_SESSION['user_name'])) {
    $welcomeMessage = "Welcome, <strong>" . htmlspecialchars($_SESSION['user_name']) . "</strong>";
} elseif (isset($_SESSION['associate_name'])) {
    $welcomeMessage = "Welcome, <strong>" . htmlspecialchars($_SESSION['associate_name']) . "</strong>";
}
?>

<div class="d-flex flex-column flex-md-row align-items-center p-3 px-md-4 mb-3 bg-white border-bottom box-shadow">
    <a href="index.php" style="color: black; text-decoration: none;">
        <h5 class="my-0 me-md-auto fw-normal">PetCare</h5>
    </a>
    <nav class="my-2 my-md-0 ms-md-auto">
        <a id="serviceLink" class="p-2 text-dark" href="service.php">Service</a>
    </nav>
